...
describe("WordPress Android - " + desired.deviceName, function () {
  ...
  it("should log in", function () {
    ...
    return driver.elementById("org.wordpress.android.beta:id/nux_username")
        .should.eventually.exist
        .elementById("org.wordpress.android.beta:id/nux_username").click().sendKeys(test_username)
        .elementById("org.wordpress.android.beta:id/nux_password").click().sendKeys(test_password)
	.takeScreenshot()
        .elementById("org.wordpress.android.beta:id/nux_sign_in_button").click()
